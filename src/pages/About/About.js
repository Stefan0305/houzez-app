          ...
          <div className="vision-body">
            <div className="column">
              <p>
                ...
                where modern aesthetics are combined with a tasteful simplicity
            ...
            <div className="column">
              ...
              <p>
                ...
                <span>
                  {" "}
                  Houzez offers a limitless array of possibilities to structure
                  and style your content.
                </span>{" "}
            ...
            <div className="employee-card">
              ...
              <div className="hover-details">
                ...
                <p>
                  ...
                  Natus libero voluptate minima voluptates perferendis
                  blanditiis nostrum totam quaerat eos nobis?
                </p>
      ...
      <section className="services">
        <div className="container">
          ...
          <div className="services-body">
            <div className="box-item small-box">
            ...
            <div className="box-item big-box">
              <div className="box-overlay"></div>
              <div className="box-title">
                <p>Services</p>
